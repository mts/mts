...
import {
  footer,
  footerTopLinks,
  footerTopLinksPrimary,
  footerTopLinksPrimaryLabel,
  footerTopLinksPrimaryLink,
  footerTopLinksSecondary,
  footerTopLinksSecondaryLabel,
  footerTopLinksSecondaryLink,
  footerSocialIcons,
  footerSocialIconsList,
  footerSocialIconsListItem,
  footerBottomLinks,
  footerBottomLinksLink,
} from './Footer.scss'
  ...
  return (
    <footer className={cx(className, footer)}>
      <div className={footerTopLinks}>
        <div className={footerTopLinksPrimary}>
          <small className={footerTopLinksPrimaryLabel}>Portfolio</small>
          <ul>
            <li className={footerTopLinksPrimaryLink}>
              <a
        ...
        <div className={footerTopLinksSecondary}>
          <small className={footerTopLinksSecondaryLabel}>About</small>
          <ul>
            <li className={footerTopLinksSecondaryLink}>
      ...
      <div className={footerSocialIcons}>
        <small>© MTS</small>
        <ul className={footerSocialIconsList}>
          <li className={footerSocialIconsListItem}>
            <a
          ...
          <li className={footerSocialIconsListItem}>
            <a
              href="https://www.instagram.com/willsmith/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Go To Social Media: instagram-round"
            >
              <svg width="30px" height="30px" viewBox="0 0 49.652 49.652">
        ...
        <ul className={footerBottomLinks}>
          <li className={footerBottomLinksLink}>
            <a href="mailto:will@belairathletics.com/" target="_blank" rel="noopener noreferrer" aria-label="Go To Footer Link: Contact Me">
              <small>Contact Me</small>
            </a>
          </li>
          <li className={footerBottomLinksLink}>
            <a itemProp="url" aria-label="Go To Footer Link: Privacy &amp; Terms" href="/legal">
