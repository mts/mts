    ...
    <footer className={className}>
      ...
      <div className={topBorder}>
        <div className={container2}>
          <small>© MTS</small>
          <ul className={container2SocialIconsLinks1}>
            <li className={container2SocialIconsLinks1Link}>
              <a
          ...
          <ul className={container2SocialIconsLinks2}>
            <li className={container2SocialIconsLinks2Link}>
              <a
                href="mailto:will@belairathletics.com/"
                target="_blank"
                rel="noopener noreferrer"
