    ...
    <main className={cx(className, main)}>
      <div className={mainModule}>
        ...
        <div className={mainAbout}>
          ...
          <div className={mainAboutMe}>
            <div className={mainAboutMeContainer}>
              <picture>
                <img className={mainAboutMeContainerImage} src={!windowObjectExists ? 'mts/static/me.jpg' : Me} alt="me" />
              </picture>
            </div>
          </div>
        ...
        <div className={mainOffer}>
          ...
          <ul className={mainOfferServices}>
            <li className={mainOfferServicesItem}>
        ...
        <div className={mainPortfolio}>
          ...
          <ul className={mainPortfolioItems}>
            <li className={mainPortfolioItemsItem}>
              <a
                className={mainPortfolioItemsItemAnchor}
            ...
            <li className={mainPortfolioItemsItem}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Portfolio Link: /blog"
              >
                <div className={mainPortfolioItemsItemAnchorImage}>
                  <picture>
