...
import {
  ...
  containerBackgroundDimmer,
  containerBackgroundCaption,
  containerBackgroundCaptionH1,
  containerBackgroundCaptionH2,
  containerAbout,
  containerAboutSectionHeader,
  containerAboutSectionHeaderH2,
  containerAboutSectionHeaderH3,
  containerAboutImage,
  containerAboutImageContainer,
  containerAboutSocialIcons,
  ...
  containerPortfolioItemsItemImageContainer,
  containerPortfolioItemsItemCaption,
  containerTimeline,
  containerTimelineSectionHeader,
  containerTimelineSectionHeaderH2,
  containerTimelineSectionHeaderH3,
  containerTimelineItems,
  containerTimelineItemsItem,
  containerTimelineItemsItemMemoryImage,
  containerTimelineItemsItemMemoryImageContainer,
  containerTimelineItemsItemCaption,
  containerTimelineItemsItemNewestMemory,
  containerTest,
  containerTestSectionHeader,
  containerTestSectionHeaderH2,
  containerTestSectionHeaderH3,
  containerTestItems,
  containerTestItemsItem,
  containerTestItemsItemImage,
  containerTestItemsItemImageContainer,
  containerTestItemsItemCaption,
  containerTestItemsItemCaptionP1,
  containerTestItemsItemCaptionP2,
} from './HomeMain.scss'
      ...
      <div className={container}>
        <div className={containerBackground}>
          ...
          <div className={containerBackgroundCaption}>
            ...
            <h2 className={containerBackgroundCaptionH2}>React.js, Node.js and GraphQL</h2>
          </div>
        </div>

        <div className={containerAbout}>
          <div className={containerAboutSectionHeader}>
            <h2 className={containerAboutSectionHeaderH2}>About me</h2>
          ...
          <ul className={containerAboutSocialIcons}>
            <li className={containerAboutSocialIconsIcon}>
              <a
        ...
        <div className={containerTimeline}>
          <div className={containerTimelineSectionHeader}>
            <h2 className={containerTimelineSectionHeaderH2}>TIMELINE</h2>
            <h3 className={containerTimelineSectionHeaderH3}>MY PROFESSIONAL STORY.</h3>
          </div>
          <ul className={containerTimelineItems}>
            ...
            <li className={containerTimelineItemsItem}>
              <div className={containerTimelineItemsItemMemoryImage}>
                <div className={containerTimelineItemsItemMemoryImageContainer}>
                  <div className={containerTimelineItemsItemNewestMemory}>
        ...
        <div className={containerTest}>
          <div className={containerTestSectionHeader}>
            <h2 className={containerTestSectionHeaderH2}>Testimonials</h2>
            <h3 className={containerTestSectionHeaderH3}>What industry leaders are saying</h3>
          </div>
          <ul className={containerTestItems}>
            <li className={containerTestItemsItem}>
              <a
              ...
              <div className={containerTestItemsItemCaption}>
                <h4>Lorem Ipsum</h4>
                <p className={containerTestItemsItemCaptionP1}>Lorem ipsum dolor sit</p>
                <LoremIpsum className={containerTestItemsItemCaptionP2} container={element.paragraph} length={size.x1Small} count={1} />
              </div>
            </li>
            <li className={containerTestItemsItem}>
              <a
